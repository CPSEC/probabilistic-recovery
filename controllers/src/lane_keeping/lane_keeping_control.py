...
K_DETECTION = 71# Time attack begins. To be moved to a param file
K_MAX = 50
...
class RTSS:
	...
	def __init__(self, Ad, Bd, Cd, Dd, W, u_min, u_max, recovery_index):
		...
		# Create strip
		self.s = Strip(np.array([0, -1, -0.3]), a=-0.08, b=0.08)
		# Attack detection
...
def main():
	...
	while not rospy.is_shutdown():
		...
		if k == K_DETECTION: # attack controller
			...
			# print("Reconfiguration begins!!: ", position_fetcher.get_odometer_info(), "strip: ", rtss.s.l @ state)
			if ISOLATION: #  recovery with isolation
				...
				# print("reconstructed:", rtss.x_cur_update)
				...
				# print("reconstructed:", rtss.x_res_point)
				# print(u_recovery)
